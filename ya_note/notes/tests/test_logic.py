...
class TestAddNotes(TestCase):
    ...
    def test_authorized_user_can_add_note(self):
        ...
        response = self.client.post(
            reverse(Views.ADD_NOTE), data=self.note_form
        )
        self.assertRedirects(response, reverse(Views.SUCCESS))
    ...
    def test_anonymous_cant_add_note(self):
        login_url = reverse(Views.LOGIN)
        url = reverse(Views.ADD_NOTE)
...
class TestNotesEdit(TestCase):
    ...
    def test_author_can_edit_note(self):
        url = reverse(Views.EDIT_NOTE, args=(self.note.slug,))
        self.client.force_login(self.author)
        response = self.client.post(url, data=self.note_form)
        self.assertRedirects(response, reverse(Views.SUCCESS))
    ...
    def test_author_can_delete_note(self):
        url = reverse(Views.DELETE_NOTE, args=(self.note.slug,))
        self.client.force_login(self.author)
